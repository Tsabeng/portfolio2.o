...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Plateforme de commerce en ligne complète avec panier et paiement sécurisé",
      image: project2,
    ...
    },
    {
      ...
      description: "Application mobile moderne avec interface utilisateur intuitive",
      image: project3,
      tags: ["React Native", "UI/UX", "API"],
      link: "#",
      github: "#",
    },
  ];
